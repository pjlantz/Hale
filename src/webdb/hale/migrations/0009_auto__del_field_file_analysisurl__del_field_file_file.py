...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'File.analysisurl'
        db.delete_column('hale_file', 'analysisurl')

        # Deleting field 'File.file'
        db.delete_column('hale_file', 'file')
    
    
    def backwards(self, orm):
        
        # Adding field 'File.analysisurl'
        db.add_column('hale_file', 'analysisurl', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)

        # Adding field 'File.file'
        db.add_column('hale_file', 'file', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100), keep_default=False)
