...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Botnet.hash'
        db.delete_column('hale_botnet', 'hash')

        # Adding field 'Botnet.botnethashvalue'
        db.add_column('hale_botnet', 'botnethashvalue', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=32), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Botnet.hash'
        db.add_column('hale_botnet', 'hash', self.gf('django.db.models.fields.CharField')(default='', max_length=32, unique=True), keep_default=False)

        # Deleting field 'Botnet.botnethashvalue'
        db.delete_column('hale_botnet', 'botnethashvalue')
