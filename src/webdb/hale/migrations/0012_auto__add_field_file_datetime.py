...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'File.datetime'
        db.add_column('hale_file', 'datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2010, 8, 2), blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'File.datetime'
        db.delete_column('hale_file', 'datetime')
