...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Proxy.password'
        db.alter_column('hale_proxy', 'password', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True))

        # Changing field 'Proxy.user'
        db.alter_column('hale_proxy', 'user', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Proxy.password'
        db.alter_column('hale_proxy', 'password', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Proxy.user'
        db.alter_column('hale_proxy', 'user', self.gf('django.db.models.fields.CharField')(max_length=32))
